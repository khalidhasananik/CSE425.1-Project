...
define dso_local noundef i32 @main() #5 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  call void @_ZNSaIiEC2Ev(%"class.std::allocator.2"* noundef nonnull align 1 dereferenceable(1) %6) #3
  invoke void @_ZNSt6vectorIiSaIiEEC2EmRKiRKS0_(%"class.std::vector.0"* noundef nonnull align 8 dereferenceable(24) %4, i64 noundef %23, i32* noundef nonnull align 4 dereferenceable(4) %5, %"class.std::allocator.2"* noundef nonnull align 1 dereferenceable(1) %6)
          to label %24 unwind label %39

24:                                               ; preds = %0
  call void @_ZNSaISt6vectorIiSaIiEEEC2Ev(%"class.std::allocator"* noundef nonnull align 1 dereferenceable(1) %9) #3
  invoke void @_ZNSt6vectorIS_IiSaIiEESaIS1_EEC2EmRKS1_RKS2_(%"class.std::vector"* noundef nonnull align 8 dereferenceable(24) %3, i64 noundef %21, %"class.std::vector.0"* noundef nonnull align 8 dereferenceable(24) %4, %"class.std::allocator"* noundef nonnull align 1 dereferenceable(1) %9)
          to label %25 unwind label %43

25:                                               ; preds = %24
  call void @_ZNSaISt6vectorIiSaIiEEED2Ev(%"class.std::allocator"* noundef nonnull align 1 dereferenceable(1) %9) #3
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector.0"* noundef nonnull align 8 dereferenceable(24) %4) #3
  call void @_ZNSaIiED2Ev(%"class.std::allocator.2"* noundef nonnull align 1 dereferenceable(1) %6) #3
  ...
  invoke void @_ZNSt6vectorIiSaIiEEC2EmRKiRKS0_(%"class.std::vector.0"* noundef nonnull align 8 dereferenceable(24) %11, i64 noundef %29, i32* noundef nonnull align 4 dereferenceable(4) %12, %"class.std::allocator.2"* noundef nonnull align 1 dereferenceable(1) %13)
          to label %30 unwind label %48

30:                                               ; preds = %25
  call void @_ZNSaISt6vectorIiSaIiEEEC2Ev(%"class.std::allocator"* noundef nonnull align 1 dereferenceable(1) %14) #3
  invoke void @_ZNSt6vectorIS_IiSaIiEESaIS1_EEC2EmRKS1_RKS2_(%"class.std::vector"* noundef nonnull align 8 dereferenceable(24) %10, i64 noundef %27, %"class.std::vector.0"* noundef nonnull align 8 dereferenceable(24) %11, %"class.std::allocator"* noundef nonnull align 1 dereferenceable(1) %14)
          to label %31 unwind label %52

31:                                               ; preds = %30
  call void @_ZNSaISt6vectorIiSaIiEEED2Ev(%"class.std::allocator"* noundef nonnull align 1 dereferenceable(1) %14) #3
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector.0"* noundef nonnull align 8 dereferenceable(24) %11) #3
  ...
  call void @_ZNSaIiEC2Ev(%"class.std::allocator.2"* noundef nonnull align 1 dereferenceable(1) %18) #3
  invoke void @_ZNSt6vectorIiSaIiEEC2EmRKiRKS0_(%"class.std::vector.0"* noundef nonnull align 8 dereferenceable(24) %16, i64 noundef %35, i32* noundef nonnull align 4 dereferenceable(4) %17, %"class.std::allocator.2"* noundef nonnull align 1 dereferenceable(1) %18)
          to label %36 unwind label %57

36:                                               ; preds = %31
  call void @_ZNSaISt6vectorIiSaIiEEEC2Ev(%"class.std::allocator"* noundef nonnull align 1 dereferenceable(1) %19) #3
  invoke void @_ZNSt6vectorIS_IiSaIiEESaIS1_EEC2EmRKS1_RKS2_(%"class.std::vector"* noundef nonnull align 8 dereferenceable(24) %15, i64 noundef %33, %"class.std::vector.0"* noundef nonnull align 8 dereferenceable(24) %16, %"class.std::allocator"* noundef nonnull align 1 dereferenceable(1) %19)
          to label %37 unwind label %61

37:                                               ; preds = %36
  call void @_ZNSaISt6vectorIiSaIiEEED2Ev(%"class.std::allocator"* noundef nonnull align 1 dereferenceable(1) %19) #3
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector.0"* noundef nonnull align 8 dereferenceable(24) %16) #3
  call void @_ZNSaIiED2Ev(%"class.std::allocator.2"* noundef nonnull align 1 dereferenceable(1) %18) #3
  call void @_Z14matrixMultiplyRKSt6vectorIS_IiSaIiEESaIS1_EES5_RS3_(%"class.std::vector"* noundef nonnull align 8 dereferenceable(24) %3, %"class.std::vector"* noundef nonnull align 8 dereferenceable(24) %10, %"class.std::vector"* noundef nonnull align 8 dereferenceable(24) %15)
  store i32 0, i32* %1, align 4
  call void @_ZNSt6vectorIS_IiSaIiEESaIS1_EED2Ev(%"class.std::vector"* noundef nonnull align 8 dereferenceable(24) %15) #3
  call void @_ZNSt6vectorIS_IiSaIiEESaIS1_EED2Ev(%"class.std::vector"* noundef nonnull align 8 dereferenceable(24) %10) #3
...
10:                                               ; preds = %2
  call void @_ZSt20__throw_length_errorPKc(i8* noundef getelementptr inbounds ([49 x i8], [49 x i8]* @.str, i64 0, i64 0)) #16
  unreachable
