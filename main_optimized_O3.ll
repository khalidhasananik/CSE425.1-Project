...
@isprime = dso_local local_unnamed_addr global [100000 x i8] zeroinitializer, align 16
...
define dso_local void @_Z10sieve_w_pbv() local_unnamed_addr #4 personality i32 (...)* @__gxx_personality_v0 {
  tail call void @llvm.memset.p0i8.i64(i8* noundef nonnull align 16 dereferenceable(100000) getelementptr inbounds ([100000 x i8], [100000 x i8]* @isprime, i64 0, i64 0), i8 1, i64 100000, i1 false) #11, !tbaa !10
  store i8 0, i8* getelementptr inbounds ([100000 x i8], [100000 x i8]* @isprime, i64 0, i64 1), align 1, !tbaa !10
  store i8 0, i8* getelementptr inbounds ([100000 x i8], [100000 x i8]* @isprime, i64 0, i64 0), align 16, !tbaa !10
  br label %2
...
47:                                               ; preds = %10, %45
  %48 = mul nsw i64 %4, %4
  %49 = icmp ult i64 %48, 100000
  br i1 %49, label %50, label %55

50:                                               ; preds = %47, %50
  %51 = phi i64 [ %53, %50 ], [ %48, %47 ]
  %52 = getelementptr inbounds [100000 x i8], [100000 x i8]* @isprime, i64 0, i64 %51
  store i8 0, i8* %52, align 1, !tbaa !10
  %53 = add nuw nsw i64 %51, %4
  %54 = icmp ult i64 %53, 100000
...
58:                                               ; preds = %55
  %59 = getelementptr inbounds [100000 x i8], [100000 x i8]* @isprime, i64 0, i64 %56
